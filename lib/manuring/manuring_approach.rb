    ...
    class ManuringApproach < Calculus::ManureManagementPlan::Approach
      ...
      def daily_nitrogen_production(animals)
        ...
        for animal in animals
          ...
          if Nomen::Varieties[animal.variety] <= :bos and animal.can("produce(milk)")
            if avg_milk
          ...
          items = Manuring::Abaci::NmpFranceAnimalNitrogenProduction.list.select do |item|
