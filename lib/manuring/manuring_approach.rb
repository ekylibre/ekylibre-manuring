module Manuring
    ...
    class ManuringApproach < Calculus::ManureManagementPlan::Approach
      ...
      def initialize(application)
        ...
        @available_water_capacity = parameters["available_water_capacity"].to_d || 0
        @average_precipitation_between_october_and_march = parameters["average_precipitation_between_october_and_march"].to_d || 350
        ...
        @mineral_nitrogen_at_opening = parameters["mineral_nitrogen_in_soil_at_opening"].to_d || 0.0
